...
self.toolbox.router.get('/web-origin', function() {
  return new Response('/web-with-origin-option');
}, {origin: /developers\.google\.com$/});

// Needed for 'Regex routing'
self.toolbox.router.get(/developers\.google\.com\/web-regex/, function() {
  return new Response('/web-with-regex');
});
